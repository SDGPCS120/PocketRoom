...
class ProductList extends ConsumerWidget {
  ...
  Widget _buildAiSearchResults(
    ...
    return switch (state) {
      ...
      AiSearchSuccess(results: final results) => Column(
          children: [
            // Search info banner
            Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.auto_awesome, size: 20, color: Color(0xFF2D2D2D)),
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ProductCard(furniture: results[index]);
                },
              ),
            ),
          ],
        ),
      AiSearchEmpty(query: final query) => Center(
          child: Padding(
      ...
      AiSearchError(message: final message, query: final query) => Center(
          child: Padding(
            padding: const EdgeInsets.all(32),
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
      ...
      AiSearchInitial() => const SizedBox.shrink(), // Should never reach here
    };
  }
}
