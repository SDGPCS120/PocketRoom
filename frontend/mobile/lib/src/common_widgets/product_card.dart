...
class _ProductCardState extends ConsumerState<ProductCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final ratingLabel = furniture.rating.isNaN ? 'N/A' : furniture.rating.toString();
    ...
    final brandLabel =
        furniture.brand.trim().isEmpty ? 'N/A' : furniture.brand.toUpperCase();
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  VendorPage(vendorName: furniture.brand),
                            ),
                          );
                        },
                        child: Text(
                          ...
                          style: const TextStyle(
                            ...
                            letterSpacing: 1,
                            color: AppColors
                                .primary, // Changed to primary to show it's clickable
                          ),
                        ),
                      ),
                    ),
                      ...
                      onTap: () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            ...
                            backgroundColor:
                                isFavorite ? Colors.grey[800] : AppColors.primary,
                          ),
                        );
                      },
                      child: Container(
